...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
        ...
        <!-- Mobile navbar toggle - hamburger button -->
                                ...
                                if(!$menu_item->menu_item_parent) {
                                    ...
                                    <?php } else { ?>
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle <?php echo !empty($menu_item_classes) ? $menu_item_classes : '' ?>" href="<?php echo esc_url($menu_item->url) ?>" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                <?php echo esc_html($menu_item->title) ?>
                                            </a>
